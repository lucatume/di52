...
class ResolverTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * @test
	 * it should resolve singleton bindings of different interface with same implementation to same instance
	 */
	public function it_should_resolve_singleton_bindings_of_different_interface_with_same_implementation_to_same_instance() {
		$container = $this->makeInstance();
